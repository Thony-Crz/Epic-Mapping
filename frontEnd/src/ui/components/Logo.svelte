...
<div class="flex items-center gap-3">
	...
	<div class="flex flex-col">
		<span
			class="font-bold {currentSize.text} bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 bg-clip-text text-transparent"
		>
			Epic Mapping
		</span>
		{#if size === 'lg'}
			<span class="-mt-1 text-xs text-gray-500">Communication & Decisions</span>
		{/if}
	</div>
</div>
